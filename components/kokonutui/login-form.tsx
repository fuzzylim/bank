      ...
      <form onSubmit={handleSubmit}>
        <CardContent className="space-y-4">
          ...
          <div className="text-sm text-gray-500 dark:text-gray-400">
            ...
            <p>
              Username: <code>robert.uk.29@example.com</code>
            </p>
            <p>
              Password: <code>d9c663</code>
            </p>
          </div>
          {/* Display whether the consumer key is set */}
          <div className="text-sm text-gray-500 dark:text-gray-400">
            <p>Consumer Key: {isConsumerKeySet ? "Set" : "Not set"}</p>
          </div>
        </CardContent>
